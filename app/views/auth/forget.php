<div class=' w-1/2 mx-auto p-5 mt-10 mb-10 rounded-xl shadow-xl'>
      <form action="<?= BASEURL ?>/login/forget" method="POST" class='container' >
        <div class='card-body'>
          ...
          <div class='card-body'>
            ...
            <div class='mb-4'>
              ...
              <p class=''>Password</p>
              <a href="forget" class='text-blue-500'>Lupa Sandi?</a>
              </div>
          ...
          <div class='flex justify-center p-5'>
            <p class='text-center mt-2 text-sm'>Belum Punya Akun? <Link to='/register'><a href="register" class='font-semibold text-blue-700'>Yuk Daftar!😃</a></Link></p>
          </div>
          </div>
        </div>
      </form>
