<div class=' w-4/5 md:w-1/2 mx-auto p-5 mt-10 mb-10 rounded-xl shadow-xl'>
      <form action="?controller=Admin&method=logAdmin" method="POST" class='container' >
        <div class='card-body'>
          ...
          <div class='card-body'>
            <div class='mb-4'>
              ...
              <input name="username_admin" required type="text" value="" class='border w-full rounded-md px-2 h-10 border-blue-200'/>
            </div>
            <div class='mb-4'>
              <div class='mb-2 flex flex-wrap justify-between'>
              <p class=''>Password</p>
              </div>
              <input name="password_admin" required type="password" value="" class='border w-full rounded-md px-2 h-10 border-blue-200'/>
            </div>
          </div>
