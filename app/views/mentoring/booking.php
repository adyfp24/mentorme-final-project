<div>
      ...
      <?php foreach($data['detail'] as $detail): ?> 
        <div class="w-full md:w-1/2 md:ml-4 md:mr-4 mt-4">
          <div class="md:mb-0 w-full mx-auto relative">
            <div class="px-4 lg:px-0">
              <h2 class="text-4xl font-semibold mb-4 text-blue-700"><?=$detail['judul']?></h2>
              <h2 class="text-2xl font-semibold text-blue-700"><?=$detail['nama_mentor']?></h2>
              <hr class="bg-blue-700 mr-4 md:mr-0" />
              <p class="py-2 text-xl text-blue-700 font-semibold justify-center"><?=$detail['fee']?></p>
            </div>
          </div>
          ...
          <div class="flex flex-col lg:flex-row lg:space-x-2">
            <div class="px-4 lg:px-0 mt-4 text-gray-700 text-lg leading-relaxed w-full lg:w-3/4">
              <div>
                ...
                <hr class="bg-blue-700 mr-4 md:mr-0" />
                <p class="pb-6 text-blue-700 font-semibold"><?=$detail['tempat']?></p>
              </div>
              <div>
                <h2 class="text-2xl text-blue-700 font-semibold mb-1 mt-1">Waktu</h2>
                <hr class="bg-blue-700 mr-4 md:mr-0" />
                <p class="pb-6 text-blue-700 font-semibold"><?=$detail['jadwal']?></p>
              </div>
            </div>
          </div>
        </div>
